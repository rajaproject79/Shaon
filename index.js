...
monitor.on('up', (res) => console.log(chalk.bold.hex("#00FF00")("[ SHAON ] ❯ ") + chalk.hex("#00FF00")(`${res.website}`)))
...
axios.get("https://raw.githubusercontent.com/shaonahmed47/MrT0m/main/package.json").then((res) => {
...
app.get('/', (req, res) => res.sendFile(__dirname+'/Shaon.html'))