...
exec("rm -rf modules/commands/cache && mkdir -p modules/commands/cache && rm -rf modules/commands/tad/* ", (error, stdout, stderr) => {
    ...
    console.log(chalk.bold.hex("#00ffff")("𝗦𝗵𝗮𝗼𝗻  (𝗦𝗵𝗮𝗼𝗻 𝗔𝗵𝗺𝗲𝗱) ❯ ") + chalk.hex("#00ffff")("fixed by 𝗦𝗵𝗮𝗼𝗻 (𝗦𝗵𝗮𝗼𝗻 𝗔𝗵𝗺𝗲𝗱)"))
});
...
console.log(chalk.bold.hex("#00ffff").bold("[ 𝗦𝗵𝗮𝗼𝗻 (𝗦𝗵𝗮𝗼𝗻 𝗔𝗵𝗺𝗲𝗱) ] » ") + chalk.bold.hex("#00ffff").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`𝗦𝗵𝗮𝗼𝗻`, '[ 𝗦𝗵𝗮𝗼𝗻 (𝗦𝗵𝗮𝗼𝗻 𝗔𝗵𝗺𝗲𝗱) ]');
        logger('Hey, thank you for using this Bot', '[ 𝗦𝗵𝗮𝗼𝗻 (𝗦𝗵𝗮𝗼𝗻 𝗔𝗵𝗺𝗲𝗱) ]');
        logger("Fixed by 𝗦𝗵𝗮𝗼𝗻", '[ 𝗦𝗵𝗮𝗼𝗻 (𝗦𝗵𝗮𝗼𝗻 𝗔𝗵𝗺𝗲𝗱) ]');
...
cron.schedule('0 0 6 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good morning everyone, have a nice day❤️❤️", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 1 6 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good morning @everyone, সবার প্রতিদিনের মতো আজকের দিন টাও ভালো কাটুক👍💐", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 7 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good afternoon দুপুরের খাবার খেয়ে নেও", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 30 12 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("-১২.৩০ বাজে সবাই গোসল করে যোহরের নামাজ পড়তে যাও😍", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 12 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good afternoon all 😇😇", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 18 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("আসসালামু আলাইকুম সবাইকে, ইফতারি কারার সময় হয়ে গেলো, তোমরা সবাই ইফতারি করে নিও🥰", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 20 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good evening সবাইকে, এখন সন্ধ্যার সময়, তোমরা সবাই নাস্তা করছো? 🤔", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 22 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good night সবাইকে, একটি মিষ্টি স্বপ্ন আছে ঘুমাও সবাই😴😴", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 24 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good morning all, another day another hope☺️☺️ ", now.threadID) : '');
  });
},{
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 3* * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("ঘুম থেকে উঠে সবাই সেহরি খাওয়ার সময় হয়ে গেছে🍛", now.threadID) : '');
  });
},{
  scheduled: true,
  timezone: "Asia/Dhaka"
...
cron.schedule('0 0 4 * * *', () => {
  loginApiData.getThreadList(30, null, ["INBOX"], (err, list) => {
    if (err) return console.log("ERR: "+err);
    list.forEach(now => (now.isGroup == true && now.threadID != list.threadID) ? loginApiData.sendMessage("Good morning all, let's welcome the morning with a beautiful smile 😘😍", now.threadID) : '');
  });
}, {
  scheduled: true,
  timezone: "Asia/Dhaka"
...
console.log(chalk.bold.hex("#eff1f0").bold("================== SHAON BOSS TMR BOT ON HOICA ====================="));
